...
export const metadata = {
  title: "SaaS Engineering — Auren Studios",
  description:
    "MVP-to-platform engineering for early-stage and scaling SaaS teams.",
}
...
const SHIPS = [
  {
    n: "01",
    t: "Spec & schema",
    d: "Domain model, ERD, API contract.",
    tags: ["postgres", "openapi"],
  },
  {
    n: "02",
    t: "MVP build",
    d: "Auth, core flows, dashboards.",
    tags: ["next.js", "supabase"],
  },
  {
    n: "03",
    t: "Billing & ops",
    d: "Stripe, usage metering, admin tools.",
    tags: ["stripe", "admin"],
  },
  {
    n: "04",
    t: "Infra & observability",
    d: "CI, deploys, alerts, on-call playbook.",
    tags: ["vercel", "sentry"],
  },
]
...
const PROCESS = [
  {
    n: "01",
    t: "Brief",
    d: "Domain, users, and constraints in a single page. We agree the shape before code.",
  },
  {
    n: "02",
    t: "Build",
    d: "Schema → MVP → billing → infra, on one cadence with weekly demos.",
  },
  {
    n: "03",
    t: "Handover",
    d: "Live platform, on-call playbook, plain-English docs and a Loom walkthrough.",
  },
]
...
export default function Page() {
  return (
    <main className="relative z-10 min-h-svh bg-transparent text-bone">
      ...
      <SectionHeader
        no="00"
        kicker="saas engineering"
        title={
          <>
            Ship the <em className="font-serif italic">platform</em>, not just the demo.
          </>
        }
        lede="From spec to production: auth, billing, infra, and the dashboards your operators actually need."
      />
        ...
        <div className="border-hairline mx-auto grid max-w-[1440px] grid-cols-1 border-x md:grid-cols-12">
          ...
          <div className="border-hairline col-span-1 border-b p-8 md:col-span-7 md:border-b-0 md:border-r md:p-12">
            ...
            <h3 className="mt-6 font-display text-[clamp(2rem,4.5vw,3.75rem)] leading-[0.96] font-medium tracking-[-0.03em] text-bone">
              A platform that runs without <em className="font-serif italic">you</em>.
            </h3>
            <p className="mt-6 max-w-md text-sm leading-relaxed text-ash">
              Spec, schema, MVP, billing, and infra — handed back as one
              production-grade system your team can extend and operate.
            </p>
          ...
          <aside className="col-span-1 flex flex-col md:col-span-5">
            <div className="border-hairline flex flex-col gap-3 border-b p-8 md:p-10">
              <span className="label text-ash">platforms shipped</span>
              <div className="font-display text-[clamp(2.5rem,5vw,4.5rem)] leading-none font-medium tracking-tight text-bone">
                <LiveCounter value={12} />
              </div>
              <span className="label text-ash">MVPs and scaling rebuilds</span>
            </div>
            <div className="border-hairline flex flex-col gap-3 border-b p-8 md:p-10">
              <span className="label text-ash">typical MVP</span>
              <div className="font-display text-[clamp(2.5rem,5vw,4.5rem)] leading-none font-medium tracking-tight text-bone">
                <LiveCounter value={12} />
            ...
            <div className="border-hairline flex flex-col gap-3 border-b p-8 md:p-10">
              <span className="label text-ash">outages on launch</span>
              <div className="font-display text-[clamp(2.5rem,5vw,4.5rem)] leading-none font-medium tracking-tight text-bone">
                <LiveCounter value={0} />
              </div>
              <span className="label text-ash">across the last 8 launches</span>
            </div>
            <div className="flex items-center justify-between gap-4 px-8 py-6 md:px-10">
              ...
              <span className="font-mono text-xs text-ash">
                from <span className="text-ember">$24,000</span> · fixed-scope
              </span>
            </div>
          </aside>
        </div>
              ...
              <Reveal>
                <h3 className="font-display text-[clamp(2.25rem,5vw,4.5rem)] leading-[0.95] font-medium tracking-[-0.035em] text-bone">
                  <em className="font-serif italic text-ember">
                    make the platform that scales past you.
                  </em>
                </h3>
              </Reveal>
              <Reveal delay={140}>
