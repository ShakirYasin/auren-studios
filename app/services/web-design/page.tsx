...
export const metadata = {
  title: "Web Design — Auren Studios",
  description:
    "Cinematic marketing sites and product UIs built on modern stacks.",
}
...
const SHIPS = [
  {
    n: "01",
    t: "Brand / visual system",
    d: "Type, color, motion, and grid — tuned for the web, not just the deck.",
    tags: ["type", "color", "motion"],
  },
  {
    n: "02",
    t: "Component library",
    d: "Tailwind + reusable primitives your team can extend without us.",
    tags: ["tailwind", "react", "primitives"],
  },
  {
    n: "03",
    t: "CMS or static",
    d: "Sanity, Notion, MDX, or pure static — whichever your team will actually use.",
    tags: ["sanity", "MDX", "static"],
  },
  {
    n: "04",
    t: "Animation pass",
    d: "Motion that fits the brand. Felt, not loud — and accessible by default.",
    tags: ["motion", "a11y"],
  },
]
...
const PROCESS = [
  ...
  },
  {
    n: "02",
    t: "Build",
    d: "Visual system → page system → engineering, all on one cadence with weekly demos.",
  },
  {
    n: "03",
    t: "Handover",
    d: "Live site, CMS training, plain-English docs and a Loom walkthrough.",
  },
]
  ...
  return (
    <main className="relative z-10 min-h-svh bg-transparent text-bone">
      ...
      <SectionHeader
        ...
        title={
          <>
            sites that <em className="font-serif italic">feel</em> built.
          </>
        }
        lede="End-to-end marketing sites and product UIs — design system, animation, and engineering, shipped together."
      />
        ...
        <div className="border-hairline mx-auto grid max-w-[1440px] grid-cols-1 border-x md:grid-cols-12">
          ...
          <div className="border-hairline col-span-1 border-b p-8 md:col-span-7 md:border-b-0 md:border-r md:p-12">
            ...
            <h3 className="mt-6 font-display text-[clamp(2rem,4.5vw,3.75rem)] leading-[0.96] font-medium tracking-[-0.03em] text-bone">
              A site you can hand a <em className="font-serif italic">team</em>.
            </h3>
            <p className="mt-6 max-w-md text-sm leading-relaxed text-ash">
              Visual system, component library, build, and CMS — handed back as
              one coherent thing your marketing team can actually run.
            </p>
          ...
          <aside className="col-span-1 flex flex-col md:col-span-5">
            <div className="border-hairline flex flex-col gap-3 border-b p-8 md:p-10">
              <span className="label text-ash">sites shipped</span>
              <div className="font-display text-[clamp(2.5rem,5vw,4.5rem)] leading-none font-medium tracking-tight text-bone">
                <LiveCounter value={38} />
              </div>
              <span className="label text-ash">marketing + product UIs</span>
            </div>
            <div className="border-hairline flex flex-col gap-3 border-b p-8 md:p-10">
              <span className="label text-ash">typical site</span>
              <div className="font-display text-[clamp(2.5rem,5vw,4.5rem)] leading-none font-medium tracking-tight text-bone">
                <LiveCounter value={6} />
            ...
            <div className="border-hairline flex flex-col gap-3 border-b p-8 md:p-10">
              <span className="label text-ash">lighthouse perf</span>
              <div className="font-display text-[clamp(2.5rem,5vw,4.5rem)] leading-none font-medium tracking-tight text-bone">
                <LiveCounter value={0.9} decimals={1} />
              </div>
              <span className="label text-ash">target on production</span>
            </div>
            <div className="flex items-center justify-between gap-4 px-8 py-6 md:px-10">
              ...
              <span className="font-mono text-xs text-ash">
                from <span className="text-ember">$9,000</span> · fixed-scope
              </span>
            </div>
          </aside>
        </div>
              ...
              <Reveal>
                <h3 className="font-display text-[clamp(2.25rem,5vw,4.5rem)] leading-[0.95] font-medium tracking-[-0.035em] text-bone">
                  <em className="font-serif italic text-ember">
                    make the marketing site they remember.
                  </em>
                </h3>
              </Reveal>
              <Reveal delay={140}>
