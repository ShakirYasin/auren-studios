...
import { MascotCanvas } from "@/components/openclaw/mascot-canvas"

export const metadata = {
  title: "AI Agents — Auren Studios",
  description:
    "OpenClaw assistants and custom AI agents, delivered done-for-you. A service of Auren Studios.",
}
